...
public class ParseContext {
    ...
    private List<MethodDefine> doParseClass() throws ClassNotFoundException, ParseException {
        ...
        Map<String, FieldRef> parsedField = new HashMap<>();
...
//        firstField.setFullName(FIRST_OBJ_NAME);
        ...
        if (fieldExpr != null) {
            ...
            methodDefine.methodRef = parseMethodExpr(firstField, cl, methodName, method, tokenParser.parse(fieldExpr), parsedFields, typedDefines);
        }
        return methodDefine;
    }

    private static MethodRef parseMethodExpr(FieldRef firstField, ClassLoader cl, String targetMethod, Method defineMethod,
                                             final Tokens fieldTokens, Map<String, FieldRef> parsedFields, Map<String, String> typedDefines) throws ClassNotFoundException {
        Map<String, Boolean> staticTokens = AnnotationUtils.getDesignateStaticFields(defineMethod, targetMethod);
        FieldRef owner = parseFieldExpr(firstField, cl, fieldTokens, staticTokens, parsedFields, typedDefines);
