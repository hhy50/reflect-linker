...
public interface MyObjectVisitor {
     ...
     * <p>getUser.</p>
     *
     * @return a {@link io.github.hhy.linker.test.nest.case2.UserVisitor} object.
     */
    @Field.Getter("user")
    UserVisitor getUser();
     ...
     * <p>setUser.</p>
     *
     * @param user a {@link io.github.hhy.linker.test.nest.case2.UserVisitor} object.
     */
    @Field.Setter("user")
     ...
     * <p>setAge.</p>
     *
     * @param age a {@link io.github.hhy.linker.test.MyInteger} object.
     */
