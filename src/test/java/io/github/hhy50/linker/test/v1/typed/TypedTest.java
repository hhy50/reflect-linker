package io.github.hhy50.linker.test.v1.typed;
...
public class TypedTest {
    ...
    interface TypedLinker {
        ...
        @Typed(name = "user3", value = "io.github.hhy50.linker.test.v1.typed.User3")
        @Typed(name = "user2", value = "io.github.hhy50.linker.test.v1.typed.User2")
        @Method.Expr("user2.user3.getString($0)")
        public Object getUser3String(@Typed(value = "java.lang.String") Object obj);


//        @Typed(name = "users[1]", value = "io.github.hhy50.linker.test.v1.typed.User2")
        @Typed(name = "users", value = "io.github.hhy50.linker.test.v1.typed.User2[]")
