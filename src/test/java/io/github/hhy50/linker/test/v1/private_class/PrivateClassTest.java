package io.github.hhy50.linker.test.v1.private_class;
...
import io.github.hhy50.linker.test.v1.private_class.inner.InnerHolder;
...
public class PrivateClassTest {
    ...
    @Target.Bind("io.github.hhy50.linker.test.v1.private_class.inner.Inner")
    interface LInner {
        @Method.Constructor
        LInner newInstance();
    }
    ...
    public void test1() throws LinkerException, ClassNotFoundException {
        ...
        LInner innerLinker = LinkerFactory.createStaticLinker(LInner.class, Class.forName("io.github.hhy50.linker.test.v1.private_class.inner.Inner"));
    ...
    public void test2() throws LinkerException, ClassNotFoundException {
        ...
        LInner_Autolink innerLinker = LinkerFactory.createStaticLinker(LInner_Autolink.class, Class.forName("io.github.hhy50.linker.test.v1.private_class.inner.Inner"));
        Assert.assertNotNull(innerHolder.getInner());
